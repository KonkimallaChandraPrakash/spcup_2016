function ENFNew=ENFExtractionBGrid(filename,nominal)
%close all;
...
%[signal,fs] = audioread('/Users/CHANDU/Desktop/desktop/SP_CUP/MATLAB/Train_Grid_A_P1.wav');
[signal,fs] = audioread(filename);
% [signal,fs] = audioread('/Users/CHANDU/Desktop/desktop/SP_CUP/MATLAB/practice_data/Practice_');
x = signal;
%% Variable
...
%figure;spectrogram(signal,N_frame,N_Ovrlp,Nfft,fs,'yaxis');
...
F_up = harmonic_multiples*(nominalENF + width_band);
F_dn = harmonic_multiples*(nominalENF - width_band);
...
F_up = harmonic_multiples*(nominalENF + width_signal);
F_dn = harmonic_multiples*(nominalENF - width_signal);
